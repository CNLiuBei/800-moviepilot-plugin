...
class CloudUploader(_PluginBase):
    ...
    def init_plugin(self, config: dict = None):
        ...
        settings.configure(
            ...
            r2_bucket=r2_bucket,
            api_base=config.get("api_base") or "https://guangying.org",
    ...
    def _build_upload_params(self, filepath: str, tmdb_id, media_type: str,
        ...
        return {
            ...
            "cleanup_parent_depth": 2 if season and episode else 1,
        }
    ...
    def _check_and_enqueue_file(self, filepath: str, tasks: dict,
        ...
        if enqueued:
            logger.info(
                ...
                f"S{season or '?'}E{episode or '?'} | {Path(filepath).name}"
            )
            return "queued"
        ...
        return [
            {
                ...
                "content": [
                    ...
                    # 站点
                    _row(_text("api_base", "流媒体站地址", "https://guangying.org", md=6),
            ...
            "api_base": "https://guangying.org", "api_admin_key": "",
    ...
    def on_transfer_complete(self, event: Event):
        ...
        ep_str = f"S{season or '?'}E{episode or '?'}"
